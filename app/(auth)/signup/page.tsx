      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-gray-900 rounded-2xl border border-gray-800 p-8">
          ...
          <button
            ...
            className="w-full py-3 bg-gray-800 hover:bg-gray-700 border border-gray-700 text-white font-medium rounded-lg transition-colors flex items-center justify-center gap-3"
          >
